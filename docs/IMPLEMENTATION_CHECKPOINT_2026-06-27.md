...
| `aeroroute-api` | Ruff, 40 collected tests including real PostGIS migration/import/lifecycle/explanation coverage, AIRAC fix filtering/enrichment, weather forecast/fallback orchestration, dynamic wind-field corridor and pressure selection, idempotency, concurrency/deadline guards, stable errors and CORS preflight, Alembic SQL through revision 0005, sdist and wheel passed. |
...
Total automated tests observed: 132.
