...
| `aeroroute-web` | ESLint/Prettier, TypeScript, generated-client freshness, 7 unit/component tests, production build, Storybook build, 6 mocked Playwright tests and 1 real-stack Playwright test passed. |
...
Total automated tests observed: 125.
